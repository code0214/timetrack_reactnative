...
export const getHourRegs = async (limit, currentPage) => {
  try {
    store.dispatch({ type: SET_LOADING, payload: true });
    const { data: hourRegs } = await apis.getHourRegs(limit, currentPage);
...
export const getSelfcertifiedHours = async (limit, currentPage) => {
  try {
    store.dispatch({ type: SET_LOADING, payload: true });
    const { data: selfcertifiedHours } = await apis.getSelfcertifiedHours(limit, currentPage);
    store.dispatch({
...
export const getSickLeaves = async (limit, currentPage) => {
  try {
    store.dispatch({ type: SET_LOADING, payload: true });
    const { data: sickLeaves } = await apis.getSickLeaves(limit, currentPage);
    store.dispatch({
...
export const getMovableHolidayHours = async (limit, currentPage) => {
  try {
    store.dispatch({ type: SET_LOADING, payload: true });
